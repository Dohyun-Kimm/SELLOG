...
<table>
    ...
    <tr>
        ...
        <td align="center">REST API<br/>Spring Boot<br/>DataBase<br/>Chrome Extension<br/>WebSocket<br/>Member<br/>Record<br/>Test</td>
    </tr>
</table>
...
- 우측 하단에 있는 MyItems를 클릭하면 좌측 탭이 전환되며 유저가 보유한 아이템을 카테고리별로 확인할 수 있습니다. 아이템을 클릭하면 방에 해당 아이템이 나타나며, 원하는 위치와 각도를 설정하여 방을 꾸밀 수 있습니다.
